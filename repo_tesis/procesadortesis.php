...
class ProcesadorTesis {
  ...
  public function __construct($nombreServ,$rutaArch,$url_webservice) {
    $this->nombreServidor = $nombreServ;
		...
		//$this->nombreArchivo = basename($_FILES['archivopdf']['name']);
		$this->nombreArchivo = date("d-m-Y.H-i-s",time()).".pdf";
...
$resultados = new ProcesadorTesis("localhost","lab/repo_tesis/files","http://localhost/lab/pdfparser-master/analizadorpdf.php");
